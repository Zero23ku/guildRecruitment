...
<body>
                    ...
                    <div class="right-bar d-flex align-items-center">
                        <nav class="d-flex align-items-center">
                            <ul class="main-menu">
                                ...
                                <li><a href="#team">Nuestro Core</a></li>
                                <li><a href="#horarios">Horarios</a></li>
                                <li><a href="#contact">Postula</a></li>
                            </ul>
            ...
            <div class="row fullscreen justify-content-center align-items-center">
                <div class="col-lg-8">
                    <div class="banner-content text-center">
                        <p class="text-uppercase text-white">Honor Preservation</p>
                        <h1 class="text-uppercase text-white">Omae wa mou... shindeiru</h1>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-6 d-flex justify-content-center">
                    <div class="list text-center">
                        ...
                        <p class="text-uppercase">Normal</p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6 d-flex justify-content-center">
                    <div class="list text-center">
                        ...
                        <p class="text-uppercase">Heróico</p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6 d-flex justify-content-center">
                    <div class="list text-center">
                        ...
                        <p class="text-uppercase">Mítico</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Start shuffle Area -->
    <section id="protfolio" class="section-full" style="display:none !important;">
    ...
    <section id="team" class="section-full">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="product-area-title text-center">
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                    <div class="single-member">
                        <div class="thumb relative" style="background: url(${pageContext.request.contextPath}/resources/img/t1.jpg);">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single-member">
                        <div class="thumb relative" style="background: url(${pageContext.request.contextPath}/resources/img/t2.jpg);">
                            <div class="overlay overlay-member d-flex flex-column justify-content-end align-items-center">
                                <p class="text-white">This article is floated online with an aim to help you find the best dvd printing solution. Dvd</p>
                                <div class="line"></div>
                                <div class="social d-flex align-items-center justify-content-center">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single-member">
                        <div class="thumb relative" style="background: url(${pageContext.request.contextPath}/resources/img/t3.jpg);">
                            <div class="overlay overlay-member d-flex flex-column justify-content-end align-items-center">
                                <p class="text-white">This article is floated online with an aim to help you find the best dvd printing solution. Dvd</p>
                                <div class="line"></div>
                                <div class="social d-flex align-items-center justify-content-center">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single-member">
                        <div class="thumb relative" style="background: url(${pageContext.request.contextPath}/resources/img/t4.jpg);">
                            <div class="overlay overlay-member d-flex flex-column justify-content-end align-items-center">
                                <p class="text-white">This article is floated online with an aim to help you find the best dvd printing solution. Dvd</p>
                                <div class="line"></div>
                                <div class="social d-flex align-items-center justify-content-center">
    ...
    <section id="horarios" class="section-full studio-area">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="studio-content">
                        <p class="text-uppercase text-white">Horarios</p>
                        <h2 class="h1 text-white text-uppercase mb-20">COLOQUEMOS ALGUN CALENDARIO AQUI</h2>
                        <p class="text-white mb-30">Sean puntuales mierdas, no les pedimos nada, solo sean puntuales AAAA ME VOY A MATAR JAVI TUS PASTELES AAAAA</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="contact" class="section-full gray-bg">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="product-area-title text-center">
                        <h2 class="h1">Postula</h2>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-6 mt-30">
                    <p>No sé porque alguien querría jugar con nosotros, somos feos, apestosos, mancos, comunistas, pero nunca una estrella de porno. (BTW El formulario no funciona, es solo un placeholder).</p>
                </div>
                <div class="col-lg-6 mt-30">
